  ...
  return (
    <div className="space-y-4">
      <section className="card p-5">
        <h2 className="text-sm font-semibold text-slate-700 mb-2">Sube el PDF (o un .zip con varios PDF)</h2>
        ...
        >
          ...
          <input type="file" name="file" required accept=".pdf,.zip,application/pdf,application/zip" className="input" />
