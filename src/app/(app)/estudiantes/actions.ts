...
function extendedStudentFields(formData: FormData) {
  return {
    ...
    father_document_id: str(formData, "father_document_id"),
    ...
    mother_document_id: str(formData, "mother_document_id"),
    ...
    representative_document_id: str(formData, "representative_document_id"),
