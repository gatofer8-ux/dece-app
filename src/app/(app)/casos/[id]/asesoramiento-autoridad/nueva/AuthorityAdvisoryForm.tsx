...
export default function AuthorityAdvisoryForm({
  ...
  const [deceProfessionalName, setDeceProfessionalName] = useState(defaultProfessionalName || "");
  const [authorityName, setAuthorityName] = useState("");
  const [authorityRole, setAuthorityRole] = useState("Rector/a");

  const [deceSig, setDeceSig] = useState<DualSignatureData | null>(null);
  const [authoritySig, setAuthoritySig] = useState<DualSignatureData | null>(null);
